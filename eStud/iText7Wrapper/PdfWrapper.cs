...
namespace iText7Wrapper
{
    ...
    public class PdfWrapper: IDisposable
    {
        ...
        /// </summary>
        /// <param name="filePath">Pdf fajl u kome ce se upisivati podaci</param>
        public PdfWrapper(string filePath)
        {
            path = filePath;
        ...
        /// <summary>
        /// Dodaje u pdf tabelu koju pravi od DataTable objekta
        /// Tabela ima i header cells koji odgovaraju heaerima tog DataTable-a
        /// </summary>
        /// <param name="dt">DataTable koje treba uneti u tabelu</param>
        public void DodajTabelu(DataTable dt)
        {
            if (dt.Rows.Count == 0)
                return;
        ...
        /// <returns></returns>
        public static void OtvoriFile(string filePath)
        {
            var success = System.Diagnostics.Process.Start(filePath);
        }
